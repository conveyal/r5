...
Transfer from [local to inner express buses require an upgrade fare payment](https://projects.indicatrix.org/fareto-examples/?load=bos-local-express&index=1), while [transfers from inner express to local buses are free](https://projects.indicatrix.org/fareto-examples/?load=bos-express-local&index=1). The same is true for transfers [to](https://projects.indicatrix.org/fareto-examples/?load=bos-bus-outer&index=0) and [from](https://projects.indicatrix.org/fareto-examples/?load=bos-outer0bus&index=0) outer express buses.

[Inner express buses](https://projects.indicatrix.org/fareto-examples/?load=bos-inner&index=0) and [outer express buses](https://projects.indicatrix.org/fareto-examples/?load=bos-outer&index=1) have different fares, and mostly allow the same transfers. However, [transfers from inner to inner express buses](https://projects.indicatrix.org/fareto-examples/?load=bos-inner-inner&index=0) and [from outer to outer]() are not discounted. Transfers from [outer-inner](https://projects.indicatrix.org/fareto-examples/?load=bos-outer-inner&index=0) and [inner-outer]https://projects.indicatrix.org/fareto-examples/?load=bos-inner-outer&index=0() use the normal pay-the-difference transfer rule.
[Inner express buses](https://projects.indicatrix.org/fareto-examples/?load=bos-inner&index=0) and [outer express buses](https://projects.indicatrix.org/fareto-examples/?load=bos-outer&index=1) have different fares, and mostly allow the same transfers. However, [transfers from inner to inner express buses](https://projects.indicatrix.org/fareto-examples/?load=bos-inner-inner&index=0) and from outer to outer are not discounted.
