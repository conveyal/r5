...
/**
 * An immutable group of tags to be added to the worker instance to assist in usage analysis and
 * cost breakdowns. These Strings are purely for categorization of workers and should not be used
 * for other purposes, only passed through to the AWS SDK.
 */
