...
public class AdjustSpeed extends Modification {
    ...
    /**
     * At least one trip from each pattern to modify. Does not select single trips, only whole
     * patterns.
     */
    public String[] trips;
    ...
    public com.conveyal.r5.analyst.scenario.AdjustSpeed toR5() {
        com.conveyal.r5.analyst.scenario.AdjustSpeed as =
                new com.conveyal.r5.analyst.scenario.AdjustSpeed();
        as.comment = name;
