...
public class Bounds {
    ...
    /**
     * The latitude of the north edge and south edge, the longitude of the east edge and west edge
     * of the box.
     */
    ...
    public boolean equals(Object other, double tolerance) {
        ...
        return Math.abs(north - o.north) <= tolerance
                && Math.abs(east - o.east) <= tolerance
                && Math.abs(south - o.south) <= tolerance
                && Math.abs(west - o.west) <= tolerance;
    }
