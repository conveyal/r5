...
public class ConvertToFrequency extends Modification {
    ...
    /**
     * Should trips on this route that start outside the days/times specified by frequency entries
     * be retained?
     */
    ...
    public static class FrequencyEntry extends AbstractTimetable {
        /**
         * start times of this trip (seconds since midnight), when non-null scheduled trips will be
         * created
         */
        @Deprecated public int[] startTimes;
