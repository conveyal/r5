...
public class Segment {
    ...
    /**
     * Geometry of this segment Generally speaking, this will be a LineString, but the first segment
     * may be a Point iff there are no more segments. This is used when someone first starts drawing
     * a line and they have only drawn one stop so far. Of course a transit line with only one stop
