...
public class LocalFileStorage implements FileStorage {
    ...
    public void moveIntoStorage(FileStorageKey key, File file) {
        ...
        try {
            ...
            // Make files read-only once put into storage, avoiding corruption from concurrent access.
            Files.setPosixFilePermissions(storedFile.toPath(), Set.of(PosixFilePermission.OWNER_READ));
        } catch (IOException e) {
