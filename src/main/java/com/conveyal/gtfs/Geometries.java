...
public class Geometries {
    ...
    /**
     * Taken from geofabrik.de country boundary KML, because our OSM PBF files use this same
     * boundary.
     */
    public static Geometry getNetherlands() {
        CoordinateSequence netherlandsBoundaryCoordinates =
    ...
    /**
     * The Dutch island of Texel. The Netherlands data set includes a crazy all-to-all
     * representation of Texel's on-demand transit service.
     */
