...
/** Created by landon on 2/3/16. TODO convert ApiMain into a Component once it's very simple. */
public class ApiMain {
    ...
    private static GTFSFeed getFeedSource(String uniqueId) {
        ...
        // TODO setting this field could be pushed down into cache.get() or even into the
        // CacheLoader, but I'm doing
    ...
    /**
     * Convenience function to get a feed source without throwing checked exceptions, for example
     * for use in lambdas.
     *
    ...
    // TODO verify that this is not used to fetch so many feeds that it will cause some of them to
    // be closed by eviction
    // TODO introduce checks on quantity of feeds, against max cache size, and fail hard if too many
    // are requested.
