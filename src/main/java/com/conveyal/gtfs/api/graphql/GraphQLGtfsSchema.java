...
public class GraphQLGtfsSchema {
    ...
    public static GraphQLObjectType rootQuery =
            newObject()
                    .name("rootQuery")
                    .description(
                            "Root level query for routes, stops, feeds, patterns, trips, and"
                                + " stopTimes within GTFS feeds.")
                    .field(
                            newFieldDefinition()
                                    .name("routes")
                                    .description(
                                            "List of GTFS routes optionally queried by route_id"
                                                + " (feed_id required).")
                    ...
                    .field(
                            newFieldDefinition()
                                    ...
                                    .build())
                    // TODO: determine if there's a better way to get at the refs for patterns,
                    // trips, and stopTimes than injecting them at the root.
                    .field(
                            newFieldDefinition()
                                    .name("patterns")
