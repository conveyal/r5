...
public class StopType {
    public static GraphQLObjectType build() {
        ...
        // transferPerformance should be modeled after
        // com.conveyal.gtfs.stats.model.TransferPerformanceSummary
        GraphQLObjectType transferPerformance =
                newObject()
