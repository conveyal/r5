 ...
 *
 * <p>TODO de-implement Comparable and Serializable TODO parameterize with the type of affected
 * entity <T extends Entity>, with pseudo-entity for lines?
 */
public abstract class GTFSError implements Comparable<GTFSError>, Serializable {
    ...
    /**
     * @return the name of this class without a package, to be used as a unique identifier for the
     *     kind of error. By putting all these classes in the same package we guarantee they have
     *     unique names.
     */
    ...
    /**
     * @return a Class object for the class of GTFS entity in which the error was found, which also
     *     implies a table in the GTFS feed.
     */
    ...
    public int compareTo(GTFSError o) {
        ...
        int file =
                this.file == null && o.file == null
                        ? 0
                        : String.CASE_INSENSITIVE_ORDER.compare(this.file, o.file);
        ...
        int affectedEntityId =
                this.affectedEntityId == null && o.affectedEntityId == null
                        ? 0
                        : String.CASE_INSENSITIVE_ORDER.compare(
                                this.affectedEntityId, o.affectedEntityId);
