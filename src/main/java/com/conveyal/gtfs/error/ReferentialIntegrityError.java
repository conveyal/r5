...
public class ReferentialIntegrityError extends GTFSError implements Serializable {
    ...
    // TODO: maybe also store the entity ID of the entity which contained the bad reference, in
    // addition to the row number
    public final String badReference;

    public ReferentialIntegrityError(
            String tableName, long row, String field, String badReference) {
