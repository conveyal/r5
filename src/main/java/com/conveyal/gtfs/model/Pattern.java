...
public class Pattern implements Serializable {
    ...
    // This is the only place in the library we are still using the old JTS package name. These
    // objects are
    // serialized into MapDB files. We want to read and write MapDB files that old workers can
    // understand.
    ...
    // TODO: Should a Pattern be generated for a single trip or a set of trips that share the same
    // ordered stop list?
