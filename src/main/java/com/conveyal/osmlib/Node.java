...
public class Node extends OSMEntity implements Serializable {
    ...
    // PBF uses 100 nanodegrees (1e7) by default. (180 * 10^7) / (2^31) ~= 0.84 so we should be
    // fine.
    ...
    public double getLat() {
        return fixedLat / FIXED_PRECISION_FACTOR;
    }

    public double getLon() {
        return fixedLon / FIXED_PRECISION_FACTOR;
    }
