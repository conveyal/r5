...
public class GraphQLSchema {
    ...
    public GraphQLOutputType transitEdgeInfoType = new GraphQLTypeReference("TransitEdgeInfo");
    ...
    public GraphQLSchema(PointToPointQuery profileResponse) {
        ...
        transitEdgeInfoType = GraphQLObjectType.newObject()
            .name("TransitEdgeInfo")
            .description("Represents one transit network link")
            .field(GraphQLFieldDefinition.newFieldDefinition()
                .name("id")
                .type(new GraphQLNonNull(Scalars.GraphQLString))
                .description("transit edge id composed of stop IDs and route ID")
                .dataFetcher(environment -> ((TransitEdgeInfo) environment.getSource()).id)
                .build())
            .field(GraphQLFieldDefinition.newFieldDefinition()
                .name("fromStopID")
                .type(new GraphQLNonNull(Scalars.GraphQLInt))
                .description("starting GTFS stop ID for the edge")
                .dataFetcher(environment -> ((TransitEdgeInfo) environment.getSource()).fromStopID)
                .build())
            .field(GraphQLFieldDefinition.newFieldDefinition()
                .name("toStopID")
                .type(new GraphQLNonNull(Scalars.GraphQLInt))
                .description("ending GTFS stop ID for the edge")
                .dataFetcher(environment -> ((TransitEdgeInfo) environment.getSource()).toStopID)
                .build())
            .field(GraphQLFieldDefinition.newFieldDefinition()
                .name("routeID")
                .type(new GraphQLNonNull(Scalars.GraphQLString))
                .description("GTFS route ID")
                .dataFetcher(environment -> ((TransitEdgeInfo) environment.getSource()).routeID)
                .build())
            .field(GraphQLFieldDefinition.newFieldDefinition()
                .name("routeColor")
                .type(Scalars.GraphQLString)
                .description("Display color of transit route, specified by GTFS")
                .dataFetcher(environment -> ((TransitEdgeInfo) environment.getSource()).routeColor)
                .build())
            .field(GraphQLFieldDefinition.newFieldDefinition()
                .name("geometry")
                .type(Scalars.GraphQLString)
                .dataFetcher(environment -> {
                    try {
                        return JsonUtilities.objectMapper.writeValueAsString(
                            ((TransitEdgeInfo) environment.getSource()).geometry);
            ...
            .field(GraphQLFieldDefinition.newFieldDefinition()
                    ...
                    .dataFetcher(environment -> ((TransitEdgeInfo) environment.getSource()).fromDepartureTime)
                    .build())
            .field(GraphQLFieldDefinition.newFieldDefinition()
                    .name("toArrivalTime")
                    .type(new GraphQLList(GraphQLZonedDateTime))
                    .description("arrival times of to stop in this pattern")
                    .dataFetcher(environment -> ((TransitEdgeInfo) environment.getSource()).toArrivalTime)
                    .build())
            .build();
        ...
        streetEdgeInfoType = GraphQLObjectType.newObject()
            ...
            .field(GraphQLFieldDefinition.newFieldDefinition()
                ...
                .description("ISO 8061 date time when this link is entered")
                .dataFetcher(environment -> ((StreetEdgeInfo) environment.getSource()).startTime)
                .build())
        .field(GraphQLFieldDefinition.newFieldDefinition()
                .name("endTime")
                .type(new GraphQLNonNull(GraphQLZonedDateTime))
                .description("ISO 8061 date time when this link is left")
                .dataFetcher(environment -> ((StreetEdgeInfo) environment.getSource()).endTime)
                .build())
            .field(GraphQLFieldDefinition.newFieldDefinition()
        ...
        transitSegmentType = GraphQLObjectType.newObject()
            ...
            .field(GraphQLFieldDefinition.newFieldDefinition()
                .name("transitEdges")
                .type(new GraphQLList(transitEdgeInfoType))
                .dataFetcher(environment -> ((TransitSegment) environment.getSource()).transitEdges)
                .build())
            .field(GraphQLFieldDefinition.newFieldDefinition()
                .name("middle")
        ...
        itineraryType = GraphQLObjectType.newObject()
            ...
            .field(GraphQLFieldDefinition.newFieldDefinition()
                ...
                .type(new GraphQLNonNull(Scalars.GraphQLInt))
                .description("Distance in mm of all transit parts of this itinerary")
                .dataFetcher(environment -> ((Itinerary) environment.getSource()).transitDistance)
                .build())
            .field(GraphQLFieldDefinition.newFieldDefinition()
                .name("transfers")
                .type(Scalars.GraphQLInt)
        ...
        GraphQLFieldDefinition profileField = GraphQLFieldDefinition.newFieldDefinition()
            ...
            .argument(GraphQLArgument.newArgument()
                ...
                .build())
            .argument(GraphQLArgument.newArgument()
                .name("transferPenaltySecs")
                .type(Scalars.GraphQLInt)
                .description("Time (seconds) to add to each transfer for confusion, delay, imperfection")
                .defaultValue(0)
                .build())
            .argument(GraphQLArgument.newArgument()
                .name("limit")
        ...
        GraphQLFieldDefinition planField = GraphQLFieldDefinition.newFieldDefinition()
            ...
            .argument(GraphQLArgument.newArgument()
                ...
                .type(Scalars.GraphQLBoolean)
                .defaultValue(false)
                .description("Whether to include stop ids and geoJSON in transit response")
                .build())
            .argument(GraphQLArgument.newArgument()
                .name("compactEdges")
                .type(Scalars.GraphQLBoolean)
                .defaultValue(false)
                .description("Whether to join consecutive street edges that have the same name and a CONTINUE instruction")
                .build())
            .argument(GraphQLArgument.newArgument()
                .name("searchType")
                .type(searchTypeEnum)
