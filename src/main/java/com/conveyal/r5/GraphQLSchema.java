    ...
    public GraphQLSchema(ProfileResponse profileResponse) {
        ...
        routeType = GraphQLObjectType.newObject()
            ...
            .field(GraphQLFieldDefinition.newFieldDefinition()
                .name("description")
                .type(Scalars.GraphQLString)
                .dataFetcher(environment -> ((RouteShort) environment.getSource()).description)
                .build())
            .field(GraphQLFieldDefinition.newFieldDefinition()
                .name("mode")
            ...
            .field(GraphQLFieldDefinition.newFieldDefinition()
                ...
                .dataFetcher(environment -> ((RouteShort) environment.getSource()).routeColor)
                .build())
            .field(GraphQLFieldDefinition.newFieldDefinition()
                .name("textColor")
                .type(Scalars.GraphQLString)
                .description("Color that is used for text in route (it needs to be character hexadecimal number)")
                .dataFetcher(environment -> ((RouteShort) environment.getSource()).textColor)
                .build())
            .field(GraphQLFieldDefinition.newFieldDefinition()
                .name("url")
                .type(Scalars.GraphQLString)
                .description("URL with information about route")
                .dataFetcher(environment -> ((RouteShort) environment.getSource()).url)
                .build())
            .field(GraphQLFieldDefinition.newFieldDefinition()
                .name("agencyName")
                .type(new GraphQLNonNull(Scalars.GraphQLString))
