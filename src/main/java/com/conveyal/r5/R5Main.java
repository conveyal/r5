...
/**
 * Main entry point for R5. Currently only supports starting up Analyst components (not plain old
 * journey planning). This will start up either an Analyst worker or a broker depending on the first
 * argument.
 */
public class R5Main {
