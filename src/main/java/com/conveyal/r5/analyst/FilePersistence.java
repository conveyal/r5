 ...
 *
 * Currently the only implementation is S3FilePersistence.
 * This is deprecated and being merged with FileStorage.
 */
@Deprecated
public abstract class FilePersistence {
    ...
    /** This method is being migrated to FileStorage */
