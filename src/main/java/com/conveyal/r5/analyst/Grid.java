...
public class Grid {
     ...
     * false.
     *
     * The map returned is a map from int arrays containing the x y coordinates to the weights described above. Since int
     * arrays are hashed by identity, .get functions will not work as expected. However, we always just loop over the values,
     * so we don't actually need the ability to look them up.
     *
     * TODO create a PixelWeights class with x, y, and value attributes and just return it in a list.
     */
