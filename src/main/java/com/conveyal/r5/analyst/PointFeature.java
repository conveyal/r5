...
public class PointFeature implements Serializable {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(PointFeature.class);
    ...
    public void setGeom(Geometry geom) throws IllegalArgumentException {
        ...
        if( geom instanceof Point || geom instanceof Polygon){
            this.geom = geom;
        } else {
            throw new IllegalArgumentException( "Non-point, non-polygon Geometry, not supported." );
        }
    ...
    public static PointFeature fromJsonNode(JsonNode feature) throws UnsupportedGeometryException {
