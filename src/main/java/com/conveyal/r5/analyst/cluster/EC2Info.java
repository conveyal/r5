...
public class EC2Info {
    ...
    public void fetchMetadata() {
        ...
        HttpUriRequest get =
                RequestBuilder.get()
                        .setUri(EC2MetadataUtils.getHostAddressForEC2MetadataService())
        ...
        try {
            ...
            // There is a method to get a Region object, but stick to strings for deserialization
            // simplicity.
            region = EC2MetadataUtils.getEC2InstanceRegion();
            // IP address fetching should really not be tied to EC2 but for now this lets us get a
            // useable IP.
