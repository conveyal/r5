 ...
 *
 * <p>$ aws s3 ls analyst-demo-graphs $ aws sqs list-queues
 */
                ...
                .forEach(
                        i -> {
                            ...
                            request.transitModes =
                                    null; // new TraverseModeSet(TraverseMode.TRANSIT);
                            // The task type has been changed due to refactoring.
                            // We haven't tested that this works properly, but thought it would be
                            // useful to leave in the
