...
public class SegmentPattern implements Comparable<SegmentPattern> {
     ...
     *
     * <p>Trip schedule is read from pattern trip schedules and Raptor algorithm tripIndex
     *
     * <p>Time is created based on seconds from midnight and date and timezone from fromTimeDateZD
     * with help of {@link #createTime(int, ZonedDateTime)}.
     *
     ...
     */
    private int addTime(
            TripPattern pattern, int alightTime, ZonedDateTime fromTimeDateZD, int tripIndex) {
    ...
    /**
     * Creates LocalDateTime based on seconds from midnight for time and date from requested
     * ZonedDateTime
     *
    ...
    private ZonedDateTime createTime(int time, ZonedDateTime fromTimeDateZD) {
        ...
        LocalDateTime localDateTime =
                LocalDateTime.of(
                        fromTimeDateZD.getYear(),
                        fromTimeDateZD.getMonth(),
                        fromTimeDateZD.getDayOfMonth(),
                        0,
                        0);
