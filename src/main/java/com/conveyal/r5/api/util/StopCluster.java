 ...
 * to consider.
 *
 * <p>It seems to work quite well for both the Washington DC region and Portland. Locations outside
 * the US would require additional stop name normalizer modules.
 */
