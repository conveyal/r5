 ...
 *
 * <p>Used when calculating street paths between transit stop transfers in Point to point routing
 */
public class Transfer implements Comparable<Transfer> {
    public final int alightStop;
    public final int boardStop;
    // In which transitSegment is this transfer used. From transitSegment with this index to the
    // next
