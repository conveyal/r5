...
public class SpeedConfig {
    ...
    public static SpeedConfig defaultConfig() {
        ...
        speedConfig.addCarSpeed("motorway_link", 40);
        speedConfig.addCarSpeed("trunk", 60);
        speedConfig.addCarSpeed("trunk_link", 40);
        speedConfig.addCarSpeed("primary", 50);
        speedConfig.addCarSpeed("primary_link", 30);
        speedConfig.addCarSpeed("residential", 30);
        speedConfig.addCarSpeed("secondary", 40);
        speedConfig.addCarSpeed("secondary_link", 30);
        speedConfig.addCarSpeed("service", 15);
        speedConfig.addCarSpeed("tertiary", 30);
        speedConfig.addCarSpeed("tertiary_link", 30);
        speedConfig.addCarSpeed("living_street", 10);
