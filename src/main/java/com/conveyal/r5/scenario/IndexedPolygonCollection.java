...
public class IndexedPolygonCollection {
    ...
    public void loadFromS3GeoJson(FileStorage fileStorage) throws Exception {
        // FIXME How will we handle .gz data?
        File polygonInputFile = fileStorage.getFile(new FileStorageKey(DATASOURCES, polygonLayer));
