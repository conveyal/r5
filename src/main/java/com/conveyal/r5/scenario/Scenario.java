...
public class Scenario implements Serializable {
     ...
     */
    public TransportNetwork applyToTransportNetwork (TransportNetwork originalNetwork, FileStorage fileStorage) {
        ...
        for (Modification modification : modifications) {
            boolean errorsInPrefetch = modification.prefetchFiles(fileStorage);
            boolean errorsInResolve = modification.resolve(copiedNetwork);
            if (errorsInPrefetch || errorsInResolve) {
