...
public class PatternSequence {
    ...
    public PatternSequence(
            TIntList patterns,
            TIntList boardStops,
            TIntList alightStops,
            TIntList rideTimesSeconds) {
        this.patterns = patterns;
        this.stopSequence = new StopSequence(boardStops, alightStops, rideTimesSeconds);
    }

    /**
     * Given a source PatternSequence, shallow copy its patterns, and the fields of its stopSequence
     * except for the egress, which is set to the supplied egress.
     */
    public PatternSequence(PatternSequence source, StreetTimesAndModes.StreetTimeAndMode egress) {
        ...
        this.stopSequence =
                new StopSequence(
                        sequence.boardStops, sequence.alightStops, sequence.rideTimesSeconds);
