...
public class GeometryUtils {
    ...
    public static final double FIXED_DEGREES_FACTOR = 1e7; // we could just reuse the constant from osm-lib Node.
    ...
    public static void expandEnvelopeFixed(Envelope envelope, double radiusMeters) {
        ...
        double yExpansion =
                floatingDegreesToFixed(SphericalDistanceLibrary.metersToDegreesLatitude(radiusMeters));
        double xExpansion =
                floatingDegreesToFixed(SphericalDistanceLibrary.metersToDegreesLongitude(radiusMeters, floatingLat0));
    ...
    public static int floatingDegreesToFixed(double degrees) {
        return (int)(degrees * FIXED_DEGREES_FACTOR);
    }

    public static double fixedDegreesToFloating(int fixed) {
        return fixed / FIXED_DEGREES_FACTOR;
    }
