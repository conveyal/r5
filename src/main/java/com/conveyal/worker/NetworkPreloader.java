...
public class NetworkPreloader extends AsyncLoader<NetworkPreloader.Key, TransportNetwork> {
    ...
    private final WebMercatorGridPointSetCache gridPointSetCache;

    public NetworkPreloader(TransportNetworkCache transportNetworkCache, WebMercatorGridPointSetCache gridPointSetCache) {
        this.transportNetworkCache = transportNetworkCache;
        this.gridPointSetCache = gridPointSetCache;
    }
    ...
    protected TransportNetwork buildValue(Key key) {
        ...
        PointSet pointSet = gridPointSetCache.get(key.destinationGridExtents, scenarioNetwork.fullExtentGridPointSet);
