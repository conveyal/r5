...
import com.conveyal.r5.scenario.RasterCost;
import com.conveyal.r5.scenario.Scenario;
import com.conveyal.r5.scenario.ScenarioCache;
import com.conveyal.r5.scenario.ShapefileLts;
...
import com.conveyal.r5.transit.TransportNetworkException;
...
public class TransportNetworkCache implements Component {
    ...
    public synchronized TransportNetwork getNetworkForScenario (String networkId, String scenarioId) {
        ...
        if (scenarioNetwork == null) {
            ...
            scenarioNetwork = scenario.applyToTransportNetwork(baseNetwork, fileStorage);
    ...
    private TransportNetwork buildNetworkFromConfig (String networkId) {
        ...
        try {
            ...
            config = JsonUtils.lenientObjectMapper.readValue(configFile, TransportNetworkConfig.class);
        } catch (IOException e) {
        ...
        if (config.modifications != null) {
            ...
            for (Modification modification : config.modifications) {
                ...
                modification.prefetchFiles(fileStorage);
    ...
    private Scenario resolveScenario (String networkId, String scenarioId) {
        ...
        try {
            ...
            return JsonUtils.lenientObjectMapper.readValue(scenarioFile, Scenario.class);
        } catch (Exception e) {
