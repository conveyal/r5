...
@Test
    public void testRemoveStops () {
        ...
        Assertions.assertFalse(mod.transitLayer.tripPatterns.stream()
        ...
        for (TripSchedule schedule : original.tripSchedules) {
            ...
            Assertions.assertEquals("MULTIPLE_PATTERNS:trip" + schedule.arrivals[0], schedule.tripId);

            Assertions.assertArrayEquals(new int[] { 0, 500  }, a);
            Assertions.assertArrayEquals(new int[] { 0, 500 }, d);
        }
        ...
        for (TripSchedule schedule : modified.tripSchedules) {
            ...
            Assertions.assertArrayEquals(new int[] { 0, 1000  }, a);
            Assertions.assertArrayEquals(new int[] { 0, 1000 }, d);
        }
    ...
    public void testRemoveTime () {
        ...
        for (TripSchedule schedule : mod.transitLayer.tripPatterns.get(0).tripSchedules) {
            ...
            Assertions.assertArrayEquals(new int[] { 0, 1380 }, a);
            Assertions.assertArrayEquals(new int[] { 0, 1380 }, d);
        }

        Assertions.assertTrue(mod.scenarioApplicationWarnings.isEmpty());
    }
    ...
    public void testRemoveTooMuchTime () {
        ...
        for (TripSchedule schedule : mod.transitLayer.tripPatterns.get(0).tripSchedules) {
            ...
            Assertions.assertArrayEquals(new int[] { 0, 1 }, a);
            Assertions.assertArrayEquals(new int[] { 0, 1 }, d);
        }

        Assertions.assertEquals(1, mod.scenarioApplicationWarnings.size());
    }
    ...
    public void testRemoveFirstStop () {
        ...
        for (int i = 0; i < mod.transitLayer.tripPatterns.get(0).tripSchedules.size(); i++) {
            ...
            Assertions.assertArrayEquals(new int[] { 440, 970, 1500 }, a);
            Assertions.assertArrayEquals(new int[] { 470, 1000, 1500 }, d);
        }
