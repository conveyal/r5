...
public class TypeOfEdgeLabelerTest {
    ...
    public static final EnumSet<EdgeStore.EdgeFlag> PLATFORM =
            EnumSet.of(
                    EdgeStore.EdgeFlag.PLATFORM,
    ...
    public static Stream<Arguments> data() {
        ...
        EnumSet<EdgeStore.EdgeFlag> CAR_CYCLEWAY =
                EnumSet.copyOf(TraversalPermissionLabelerTest.BICYCLE_AND_CAR);
        CAR_CYCLEWAY.add(EdgeStore.EdgeFlag.BIKE_PATH);
        CAR_CYCLEWAY.add(EdgeStore.EdgeFlag.LINKABLE);

        EnumSet<EdgeStore.EdgeFlag> PEDESTRIAN =
                EnumSet.copyOf(TraversalPermissionLabelerTest.PEDESTRIAN);
        PEDESTRIAN.add(EdgeStore.EdgeFlag.LINKABLE);

        EnumSet<EdgeStore.EdgeFlag> PEDESTRIAN_BIKE_CYCLEWAY =
                EnumSet.copyOf(TraversalPermissionLabelerTest.PEDESTRIAN_AND_BICYCLE);
        ...
        return Stream.of(
                ...
                Arguments.of(
                        "monodirectional cycleway",
                        "highway=nobikenoped;cycleway=lane",
                        CAR_CYCLEWAY,
                        CAR_CYCLEWAY),
                Arguments.of(
                        "monodirectional cycleway",
                        "highway=nobikenoped;cycleway=track",
                        CAR_CYCLEWAY,
                        CAR_CYCLEWAY),
                Arguments.of(
                        "directional cycleway",
                        "highway=nobikenoped;cycleway:right=track",
                        CAR_CYCLEWAY,
                        CAR),
                Arguments.of(
                        "directional cycleway",
                        "highway=nobikenoped;cycleway:left=track",
                        CAR,
                        CAR_CYCLEWAY),
                Arguments.of(
                        "directional cycleway",
                        "highway=nobikenoped;cycleway:right=lane",
                        CAR_CYCLEWAY,
                        CAR),
                Arguments.of(
                        "directional cycleway",
                        "highway=nobikenoped;cycleway:left=lane",
                        CAR,
                        CAR_CYCLEWAY),
                Arguments.of(
                        "directional cycleway",
                        "highway=cycleway;oneway=true",
