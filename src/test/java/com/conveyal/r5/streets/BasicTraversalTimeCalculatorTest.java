...
public class BasicTraversalTimeCalculatorTest extends TurnTest {
    ...
    public void testAngle() throws Exception {
        setUp(false);
        BasicTraversalTimeCalculator calculator =
                new BasicTraversalTimeCalculator(streetLayer, true);
    ...
    /**
     * Make sure angles are right in the southern hemisphere as well. We scale by the cosine of
     * latitude, which is negative in the southern hemisphere.
     */
    @Test
    ...
    /**
     * Test that JTS returns angles that are counterclockwise from the positive X axis (so negative
     * angle is south of X axis).
     *
     * <p>This is a completely nonstandard implementation of angles so I wrote a test to ensure it's
     * stable between JTS releases.
     */
    @Test
